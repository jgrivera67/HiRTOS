...
package body HiRTOS.Separation_Kernel.Memory_Protection_Private with SPARK_Mode => On is
   ...
   is
      Hypervisor_Enabled_Regions_Bit_Mask :
         ...
         renames Partition_Hypervisor_Regions_Config_Array (Partition_Id).
                     Hypervisor_Enabled_Regions_Bit_Mask;
   begin
      --
      ...
      HiRTOS_Cpu_Arch_Interface.Memory_Protection.Hypervisor.
         Enable_Memory_Regions_Bit_Mask (Hypervisor_Enabled_Regions_Bit_Mask);
   ...
   begin
      ...
      --
      HiRTOS_Cpu_Arch_Interface.Memory_Protection.Hypervisor.
         Disable_Memory_Regions_Bit_Mask (Hypervisor_Enabled_Regions_Bit_Mask);
