   ...
   UART_Periph_Pointers : constant
      array (Valid_Cpu_Core_Id_Type) of access UART_Peripheral :=
        [Valid_Cpu_Core_Id_Type'First => UART0_Periph'Access,
         Valid_Cpu_Core_Id_Type'First + 1 => UART2_Periph'Access,
         Valid_Cpu_Core_Id_Type'First + 2 => UART3_Periph'Access,
         Valid_Cpu_Core_Id_Type'First + 3 => UART4_Periph'Access];
