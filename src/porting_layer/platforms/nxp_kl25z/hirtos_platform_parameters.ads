...
is
   ...
   Cpu_Clock_Frequency_Hz : constant := 48_000_000;

   System_Clock_Frequency_Hz : constant := Cpu_Clock_Frequency_Hz;

   Bus_Clock_Frequency_Hz : constant := Cpu_Clock_Frequency_Hz / 2;

   Timer_Counter_Clock_Frequency_Hz : constant := Cpu_Clock_Frequency_Hz;

   Num_External_Interrupts : constant := 32;

   Max_Num_MPU_Regions : constant := 9; --???

   Cpu_Atomics_Supported : constant Boolean := False;

   CLZ_Instruction_Supported : constant Boolean := False;

   BASEPRI_Register_Supported : constant Boolean := False;
...
private
   ...
   --
   Nv_Cfmconfig : constant array (Interfaces.Unsigned_8 range <>) of Interfaces.Unsigned_32 := [
      16#FFFFFFFF#,
      16#FFFFFFFF#,
      16#FFFFFFFF#,
      16#FFFFFFFE#
   ] with Linker_Section => ".FlashConfig", Unreferenced;
