...
package ESP32_C3.INTERRUPT_CORE0 is
   ...
   --  mac intr map register
   type CPU_INT_PRI_n_Register is record
      --  reg_core0_cpu_pri_0_map
      CPU_PRI_MAP : ESP32_C3.UInt4 := 16#0#;
      --  unspecified
   ...
   for CPU_INT_PRI_n_Register use record
      CPU_PRI_MAP at 0 range 0 .. 3;
   ...
   type Cpu_Interrupt_Id_Type is range 1 .. 31;

   type CPU_INT_PRI_Array_Type is array (CPU_Interrupt_Id_Type) of CPU_INT_PRI_n_Register;
   ...
   type INTERRUPT_CORE0_Peripheral is record
      ...
      CPU_INT_PRI_Array                            : aliased CPU_INT_PRI_Array_Type;
   ...
   for INTERRUPT_CORE0_Peripheral use record
      ...
      CPU_INT_PRI_Array                            at 16#118# range 0 .. (32 * 31) - 1;
