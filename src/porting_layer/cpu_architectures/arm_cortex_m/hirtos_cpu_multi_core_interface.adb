...
--
--  @summary HiRTOS multi-core CPU interface for ARM Cortex-M architecture
--
...
package body HiRTOS_Cpu_Multi_Core_Interface is
   ...
   begin
      return Valid_Cpu_Core_Id_Type'First;
   end Get_Cpu_Id;
   ...
   begin
      if HiRTOS_Platform_Parameters.Cpu_Atomics_Supported then
         loop
         ...
         begin
            Old_Value := Atomic_Counter.Counter;
            case Atomic_Operator is
               when Test_Set =>
                  if Old_Value = Value then
                     return Old_Value;
            ...
            Atomic_Counter.Counter := New_Value;
