...
is
  ...
  function Ldrex_Word
   (Word_Address : System.Address) return Cpu_Register_Type with
   Inline_Always, Suppress => All_Checks;

  function Strex_Word
   (Word_Address : System.Address; Value : Cpu_Register_Type)
    return Boolean with
   Inline_Always, Suppress => All_Checks;
  ...
  function Atomic_Fetch_Add
   (Counter_Address : System.Address; Value : Cpu_Register_Type)
  ...
  function Count_Leading_Zeros
   (Value : Cpu_Register_Type) return Cpu_Register_Type with
