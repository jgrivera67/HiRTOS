...
is
   ...
   subtype External_Interrupt_Id_Type is
     Interrupt_Id_Type
       range 32 .. 32 + HiRTOS_Platform_Parameters.Num_External_Interrupts - 1;
   ...
   subtype Valid_Interrupt_Priority_Type is
     Interrupt_Priority_Type
       range Highest_Interrupt_Priority .. Lowest_Interrupt_Priority;

   Invalid_Interrupt_Priority : constant Interrupt_Priority_Type :=
   ...
   function Per_Cpu_Initialized return Boolean
   with Ghost;
   ...
   with
     Pre =>
       Per_Cpu_Initialized
       and then Cpu_In_Privileged_Mode
   ...
   procedure Trigger_Software_Generated_Interrupt
     (Soft_Gen_Interrupt_Id : Soft_Gen_Interrupt_Id_Type;
      Cpu_Id                :
        HiRTOS_Cpu_Multi_Core_Interface.Cpu_Core_Id_Type);
...
private
   ...
   type CBAR_RES0_Type is mod 2**18 with Size => 18;

   type CBAR_PERIPHBASE_Type is mod 2**26 with Size => 26;
   ...
   with Size => 64, Bit_Order => System.Low_Order_First, Unchecked_Union;

   for CBAR_EL1_Type use
     record
   ...
   type Group_Interrupts_Enable_Type is
     (Group_Interrupts_Disabled, Group_Interrupts_Enabled)
   with Size => 1;
   ...
   --
   type ITLinesNumber_Type is range 1 .. 30 with Size => 5;
   ...
   --
   type TYPER_IDBits_Type is mod 2**5 with Size => 5;
   ...
   --
   type GIC_Interrupt_Group_Type is new Cpu_Interrupt_Line_Type with Size => 1;
   ...
   type GIC_IGROUPR_Type is
     array (One_Bit_Per_Interrupt_Field_Index_Type) of GIC_Interrupt_Group_Type
   with Volatile_Full_Access, Size => 32, Component_Size => 1;
   ...
   type GIC_Interrupt_Bit_Mask_Type is
     array (One_Bit_Per_Interrupt_Field_Index_Type) of Bit_Type
   with Component_Size => 1, Size => 32;

   --  Interrupt set-enable register for 32 interrupts
   type GIC_ISENABLER_Type is new GIC_Interrupt_Bit_Mask_Type
   ...
   type GIC_ICENABLER_Type is new GIC_Interrupt_Bit_Mask_Type
   with Volatile_Full_Access;
   ...
   type GIC_ISPENDR_Type is new GIC_Interrupt_Bit_Mask_Type
   with Volatile_Full_Access;
   ...
   type GIC_ICPENDR_Type is new GIC_Interrupt_Bit_Mask_Type
   with Volatile_Full_Access;
   ...
   type GIC_ISACTIVER_Type is new GIC_Interrupt_Bit_Mask_Type
   with Volatile_Full_Access;
   ...
   type GIC_ICACTIVER_Type is new GIC_Interrupt_Bit_Mask_Type
   with Volatile_Full_Access;
   ...
   for GIC_IPRIORITYR_Slot_Type use
     record
   ...
   type GIC_IPRIORITYR_Slot_Array_Type is
     array (Eight_Bits_Per_Interrupt_Field_Index_Type)
     of GIC_IPRIORITYR_Slot_Type
   ...
   with Size => 32, Unchecked_Union, Volatile_Full_Access;
   ...
   type GICD_IPRIORITYR_Array_Type is
     array (Eight_Bits_Per_Interrupt_Register_Index_Type)
     of GIC_IPRIORITYR_Type;

   type GIC_ITARGETSR_Slot_Cpu_Index_Type is range 0 .. 7;

   type GIC_ITARGETSR_Slot_Type is
     array (GIC_ITARGETSR_Slot_Cpu_Index_Type) of Bit_Type
   with Component_Size => 1, Size => 8;

   pragma
     Compile_Time_Error
       (HiRTOS_Platform_Parameters.Num_Cpu_Cores > GIC_ITARGETSR_Slot_Type'Length,
        "Unsupported number of CPU cores");

   type GIC_ITARGETSR_Slot_Array_Type is
     array (Eight_Bits_Per_Interrupt_Field_Index_Type)
     of GIC_ITARGETSR_Slot_Type
   with Component_Size => 8, Size => 32;
   ...
   type GIC_ICFGR_Type (As_Word : Boolean := True) is record
      case As_Word is
         ...
         when False =>
            Interrupt_Trigger_Mode_Array :
              GIC_ICFGR_Interrupt_Trigger_Mode_Array_Type;
      end case;
   end record
   with Size => 32, Unchecked_Union, Volatile_Full_Access;
   ...
   --  number.
   --
   type GICD_SGIR_Target_List_Type is mod 2**5 with Size => 5;

   --  Software generated interrupts:
   type SGI_INTID_Type is mod 2**4 with Size => 4;
   ...
   type GICD_SGIR_Type (As_Value : Boolean := False) is record
      case As_Value is
         ...
         when False =>
            ...
            Target_List : GICD_SGIR_Target_List_Type :=
              GICD_SGIR_Target_List_Type'First;
      end case;
   end record
   with
     Size      => 32,
   ...
   with Import, Address => Peripherals_Mmio_Map.GICD_Base_Address;

   ----------------------------------------------------------------------------
   --  GIC CPU interface registers
   ----------------------------------------------------------------------------

   type INTID_Type is mod 2**24 with Size => 24;
   ...
   with Size => 32, Bit_Order => System.Low_Order_First, Volatile_Full_Access;

   for ICC_IAR_Type use
     record
   ...
   --  TRM.
   --
   type Binary_Point_Type is mod 2**3 with Size => 3;
   ...
   with Import, Address => Peripherals_Mmio_Map.GICC_Base_Address;

   ----------------------------------------------------------------------------
   --  Interrupt controller state variables
   ----------------------------------------------------------------------------

   type Per_Cpu_Flags_Array_Type is array (Valid_Cpu_Core_Id_Type) of Boolean
   with Component_Size => 1, Size => Cpu_Register_Type'Size, Warnings => Off;
   ...
   with Alignment => HiRTOS_Cpu_Arch_Parameters.Cache_Line_Size_Bytes;

   type Internal_Interrupt_Handler_Array_Type is
     array (Valid_Cpu_Core_Id_Type, Internal_Interrupt_Id_Type)
     of Interrupt_Handler_Type;
   ...
   type Interrupt_Controller_Type is record
      Per_Cpu_Initialized_Flags    :
        HiRTOS_Cpu_Multi_Core_Interface.Atomic_Counter_Type;
      GIC_Distributor_Initialized  : Boolean := False with Volatile;
      Max_Number_Interrupt_Sources : Interfaces.Unsigned_16;
      Spinlock                     :
        HiRTOS_Cpu_Multi_Core_Interface.Spinlock_Type;
   ...
   function Per_Cpu_Initialized return Boolean
   is ((HiRTOS_Cpu_Multi_Core_Interface.Atomic_Load
          (Interrupt_Controller_Obj.Per_Cpu_Initialized_Flags)
        and Bit_Mask (Bit_Index_Type (Get_Cpu_Id)))
       /= 0);
